package com.gcoolservices.acrepair.dashboard;
...
import com.gcoolservices.acrepair.BuildConfig;
import com.gcoolservices.acrepair.ContactUsActivity;
import com.gcoolservices.acrepair.MyApplication;
import com.gcoolservices.acrepair.R;
import com.gcoolservices.acrepair.SignInActivity;
import com.gcoolservices.acrepair.WebViewActivity;
import com.gcoolservices.acrepair.cart.CartActivity;
import com.gcoolservices.acrepair.database.DatabaseClient;
import com.gcoolservices.acrepair.history.MyHistoryActivity;
import com.gcoolservices.acrepair.profile.ProfileActivity;
import com.gcoolservices.acrepair.pushnotification.AccessToken;
...
import com.gcoolservices.acrepair.vendors.VendorActivity;
import com.gcoolservices.acrepair.wallet.WalletActivity;
import com.gcoolservices.acrepair.wishlist.WishListActivity;
...
//
    ...
    private void getCartList() {
        ...
        class GetTasks extends AsyncTask<Void, Void, ArrayList<com.gcoolservices.acrepair.database.Task>> {

            @Override
            protected ArrayList<com.gcoolservices.acrepair.database.Task> doInBackground(Void... voids) {
                List<com.gcoolservices.acrepair.database.Task> tasks= DatabaseClient.getmInstance(getApplicationContext())
                        .getAppDatabase()
                        .taskDao()
                        .getAll();
                return new ArrayList<com.gcoolservices.acrepair.database.Task>(tasks);
            }

            @Override
            protected void onPostExecute(ArrayList<com.gcoolservices.acrepair.database.Task> tasks) {
