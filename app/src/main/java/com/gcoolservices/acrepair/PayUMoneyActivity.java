...
public class PayUMoneyActivity extends AppCompatActivity {
     ...
     */
    int mId;
    private String mMerchantKey = "GoDa7Hsj";//For merchant and salt key you need to contact payu money tech support otherwise you get error
    private String mSalt = "siQ0SqGyTm";//copy and paste works fine
